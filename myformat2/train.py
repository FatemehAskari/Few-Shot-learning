...
if __name__ == '__main__':
    ...
    filename = 'Allinfoweight.csv'
    column_names = ['weight1', 'weight2', 'weight3', 'weight4', 'weight5', 'weight_change1', 
                    'weight_change2', 'weight_change3', 'weight_change4', 'weight_change5', 'accuracy_before_train', 'accuracy_after_train_true'
    ...
    with open(filename, 'w', newline='') as file:
        ...
        for i in range (len(weights)):
            ...
            optimizer = optim.Adam(model_true.parameters(), lr=0.001)
            ...
            # add optimizer and loss
            criterion = nn.CrossEntropyLoss()
            optimizer = optim.Adam(model_false.parameters(), lr=0.001)
            ...
            values = [weights[i][0], weights[i][1], weights[i][2], weights[i][3], weights[i][4]
                      ...
                      result_before,result_after_true,result_after_false]
