...
if __name__ == '__main__':
    ...
    model=PrototypicalNetworks(convolutional_network,weightlearnable=True).cuda()
    ...
    evaluate(val_loader,model=model)
    ...
    evaluate(val_loader,model=model)
    torch.save(model.state_dict(), osp.join(args.save_path, 'newprototypical' + '.pth'))    
